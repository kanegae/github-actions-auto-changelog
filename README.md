...
jobs:
  changelog:
    uses: kanegae/github-actions-auto-changelog/.github/workflows/changelog-unreleased-reusable.yml@v1
    with:
...
jobs:
  changelog:
    uses: kanegae/github-actions-auto-changelog/.github/workflows/changelog-release-reusable.yml@v1
    with:
